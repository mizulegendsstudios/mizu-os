// core/js/music-player.js - Reproductor de música como aplicación
export class MusicPlayer {
    ...
    // Crear panel del reproductor en el black-bar
    ...
    // Toggle panel del reproductor
    toggleMusicPlayerPanel() {
        if (!this.panel) {
