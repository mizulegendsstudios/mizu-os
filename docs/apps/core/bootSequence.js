...
export class BootSequence {
  constructor() {
    ...
    this.dependencyManager.register('moduleLoader', this.moduleLoader);
  ...
  async execute() {
    ...
    try {
      ...
      // Paso 3: Cargar módulos principales
      console.log('BootSequence: Paso 3 - Cargando módulos principales');
      await this.moduleLoader.loadCoreModules();
      this.dependencyManager.markAsLoaded('moduleLoader');
