...
export default class Core {
  ...
  async init() {
    ...
    try {
      ...
      window.Core = this;
      window.EventBus = this.modules.eventBus;
      window.AppLoader = this.modules.appLoader;
      window.CSSManager = this.modules.css;
      window.Config = this.modules.config;
      window.StatusWidget = this.modules.statusWidget;
      window.SystemUI = this.modules.systemUI;
      
      console.log('[DEBUG] Core: Módulos expuestos globalmente');
    } catch (error) {
