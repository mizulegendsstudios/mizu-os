...
export default class MusicApp {
  constructor(eventBus) {
    ...
    console.log('[DEBUG] MusicApp: Constructor llamado con EventBus:', !!eventBus);
  ...
  setupEventListeners() {
    console.log('[DEBUG] MusicApp: Configurando event listeners');
    
    // Eventos de control de música desde la barra roja
    this.eventBus.on('music:togglePlayPause', () => {
      console.log('[DEBUG] MusicApp: Recibido evento music:togglePlayPause');
      this.togglePlayPause();
    });
    
    this.eventBus.on('music:playPrev', () => {
      console.log('[DEBUG] MusicApp: Recibido evento music:playPrev');
      this.playPrev();
    });
    
    this.eventBus.on('music:playNext', () => {
      console.log('[DEBUG] MusicApp: Recibido evento music:playNext');
      this.playNext();
    });
    
    this.eventBus.on('music:toggleRepeat', () => {
      console.log('[DEBUG] MusicApp: Recibido evento music:toggleRepeat');
      this.toggleRepeat();
    });
    
    this.eventBus.on('music:toggleVolume', () => {
      console.log('[DEBUG] MusicApp: Recibido evento music:toggleVolume');
      this.toggleVolume();
    });
    
    console.log('[DEBUG] MusicApp: Event listeners configurados');
  }
  
  // Cargar el script de la API de YouTube Iframe
  loadYouTubeAPI() {
    console.log('[DEBUG] MusicApp: Cargando API de YouTube');
    
    // Verificar si ya se ha cargado la API
    if (window.YT && window.YT.Player) {
      console.log('[DEBUG] MusicApp: API de YouTube ya está cargada');
    ...
    if (document.getElementById('youtube-iframe-api')) {
      console.log('[DEBUG] MusicApp: API de YouTube ya se está cargando');
      return;
    }
    ...
    window.onYouTubeIframeAPIReady = () => {
      console.log('[DEBUG] MusicApp: YouTube Iframe Player API is ready.');
      this.isYouTubeApiReady = true;
    };
  }
  ...
  init() {
    console.log('[DEBUG] MusicApp: Inicializando aplicación de música');
    return Promise.resolve();
  }
  
  // Método render requerido por el AppLoader
  render() {
    console.log('[DEBUG] MusicApp: Renderizando interfaz de música');
    ...
    console.log('[DEBUG] MusicApp: Panel de música creado');
    return panel;
  }
  
  // Método destroy requerido por el AppLoader
  destroy() {
    console.log('[DEBUG] MusicApp: Destruyendo aplicación de música');
    this.stopAllMedia();
  ...
  async addTrack(url) {
    console.log(`[DEBUG] MusicApp: Añadiendo track desde URL: ${url}`);
  ...
  // Añadir pista local
  addLocalTrack(file) {
    console.log(`[DEBUG] MusicApp: Añadiendo track local: ${file.name}`);
  ...
  updatePlaylist() {
    ...
    console.log('[DEBUG] MusicApp: Actualizando playlist');
  ...
  removeTrack(index) {
    console.log(`[DEBUG] MusicApp: Eliminando track en índice ${index}`);
  ...
  playTrack(index) {
    console.log(`[DEBUG] MusicApp: Reproduciendo track en índice ${index}`);
  ...
  // Alternar play/pause
  togglePlayPause() {
    console.log('[DEBUG] MusicApp: Alternando play/pause');
  ...
  stop() {
    console.log('[DEBUG] MusicApp: Deteniendo reproducción');
  ...
  playNext() {
    console.log('[DEBUG] MusicApp: Reproduciendo siguiente track');
  ...
  playPrev() {
    console.log('[DEBUG] MusicApp: Reproduciendo track anterior');
  ...
  toggleRepeat() {
    console.log('[DEBUG] MusicApp: Alternando modo de repetición');
  ...
  toggleVolume() {
    console.log('[DEBUG] MusicApp: Alternando control de volumen');
  ...
  showNotification(message) {
    console.log(`[DEBUG] MusicApp: Mostrando notificación: ${message}`);
