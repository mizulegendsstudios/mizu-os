...
export default class SystemUI {
  constructor(eventBus) {
    ...
    this.elements = {};
    this.isProcessingMusicControl = false; // Nuevo: para evitar múltiples clics rápidos
  ...
  setupEventListeners() {
    ...
    this.eventBus.on('music:state-changed', (data) => {
      ...
      this.updateMusicControlsState(data.isPlaying);
    });
  }
  ...
  createVideoBackground() {
    ...
    this.videoBackground.addEventListener('error', (e) => {
      console.error('SystemUI: Error al cargar el video de fondo:', e);
  ...
  createMusicControls() {
    ...
    playPauseBtn.addEventListener('click', () => {
      ...
      if (this.isProcessingMusicControl) return;
      ...
      // Si no recibimos confirmación en 2 segundos, reactivar el botón
      setTimeout(() => {
  ...
  // Nuevo: Método para actualizar el estado de los controles de música
